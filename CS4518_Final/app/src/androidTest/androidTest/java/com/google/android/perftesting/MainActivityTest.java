...
.
    @Test
    @PerfTest
    public void turnOnInferenceTest () throws InterruptedException {
        onView(withId(R.id.inferenceToggle)).perform(click());
    }

    @Test
    @PerfTest
    public void offDeviceInferenceTest () throws InterruptedException {
        onView(withId(R.id.inferenceSourceToggle)).perform(click());
    }

    @Test
    @PerfTest
    public void soundOffTest () throws InterruptedException {
        onView(withId(R.id.soundToggleButton)).perform(click());
    }

    @Test
    @PerfTest
    public void removeGraphTest () throws InterruptedException {
        onView(withId(R.id.graphToggleButton)).perform(click());
    }
}
